...
u0[9] = 0.01
u0[17] = 0.007
prob_float32 = ODEProblem(ODEFunction{true, SciMLBase.FullSpecialize}(f, jac = fjac), u0,
                          (0.0f0, 60.0f0))
...
u0[9] = 0.01
u0[17] = 0.007
prob_float64 = ODEProblem(ODEFunction{true, SciMLBase.FullSpecialize}(f, jac = fjac), u0,
                          (0.0, 60.0))
